...
def fbconnect():
    ...
    web_json = json.loads(open('fb_client_secrets.json', 'r').read())['web']
    app_id = web_json['app_id']
    app_secret = web_json['app_secret']

    url = 'https://graph.facebook.com/oauth/access_token?grant_type='
    url += 'fb_exchange_token&client_id={}&client_secret={}&'
    ...
    userinfo_url += '?access_token={}&fields=name,id,email'
    userinfo_url = userinfo_url.format(token)
    ...
    url += '&redirect=0&height=200&width200'
...
def fbdisconnect():
    ...
    url = 'https://graph.facebook.com/{}/persmissions'
    url = url.format(facebook_id)
    h = httplib2.Http()
...
def showLogin():
    ...
    return render_template('login.html', STATE=state, FB_APP_ID=FB_APP_ID)
